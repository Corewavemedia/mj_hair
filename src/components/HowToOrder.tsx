        ...
        <section className="#C77C44 py-24 px-6 overflow-hidden min-h-screen flex flex-col justify-center">
            <div className="max-w-[1400px] mx-auto w-full">
                ...
                >
                    ...
                    <span className="text-[#EF2460] font-bold">Order</span>
                </motion.h2>
                ...
                >
                    {steps.map((step, idx) => (
                        ...
                        >
                                ...
                                <svg width="100%" height="100%" viewBox="0 0 215 239" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                                    <defs>
                                        ...
                                        <linearGradient id={`paint0_linear_${idx}`} x1="126.051" y1="218.4" x2="56.409" y2="46.5155" gradientUnits="userSpaceOnUse">
                                            <stop stopColor="#861134" />
                                            <stop offset="1" stopColor="#EF2460" />
                                        </linearGradient>
                                    </defs>
                            ...
                            {/* Icon overlay */}
                            <motion.div
                                className="absolute z-1 -top-[19px] -right-[5px] w-[130px] h-[130px] rounded-full bg-[#EF2460] flex items-center justify-center shadow-lg"
                                animate={{ y: [0, -10, 0] }}
                                transition={{
                                    duration: 4,
                                    repeat: Infinity,
